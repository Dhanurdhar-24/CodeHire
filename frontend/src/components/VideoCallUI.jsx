...
import { Loader2Icon, MessageSquareIcon, UsersIcon, XIcon, LogOutIcon } from "lucide-react";
  ...
  return (
    <div className="h-full flex gap-3 relative str-video">
      <div className="flex-1 flex flex-col gap-3">
        ...
        <div className="bg-base-100 p-3 rounded-lg shadow flex items-center justify-center gap-4">
